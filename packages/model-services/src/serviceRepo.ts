...
import { modelServices, type ModelServiceRow } from "./schema.js";
import { canonicalKind, parseService, type ServiceDef } from "./definition.js";
...
export class ServiceRepo {
  ...
  create(input: ServiceRecordInput): ModelServiceRow {
    return this.db
      ...
      .values({
        ...
        kind: canonicalKind(input.definition),
  ...
  update(
    ...
    if (input.definition !== undefined) {
      ...
      patch.kind = canonicalKind(input.definition);
    }
